function [all_feats,timestamps]=getWindowedFeats_gen(raw_data, fs, window_length, window_overlap)
% getWindowedFeats.m
%
% Description:  Filter data and compute the features specified in
%               get_features.m and get_bandpowers.m
